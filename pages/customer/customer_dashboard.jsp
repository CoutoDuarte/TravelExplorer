...
<div class="flow customer-shell">
    ...
    <%-- Duarte: esta dashboard deverá mais tarde receber dados reais do cliente autenticado, como reservas, favoritos e informação de perfil. --%>
    <%-- Duarte: a navegação destas ações já aponta para as páginas frontend certas, mas a proteção por autenticação e o carregamento de dados reais terão de ser ligados no backend. --%>
</div>
