...
<div class="flow customer-shell">
    ...
    <%-- Duarte: quando não existirem reservas, esta página poderá usar o componente empty_state.jspf com base nos dados reais do cliente autenticado. --%>
    <%-- Duarte: esta página já navega e renderiza no frontend, mas a lista real de reservas do cliente autenticado terá de ser carregada pelo backend. --%>
</div>
