...
<div class="flow customer-shell">
    ...
    <%-- Duarte: quando a lista de favoritos estiver vazia, esta página poderá mostrar o componente empty_state.jspf com base nos dados reais do cliente autenticado. --%>
</div>