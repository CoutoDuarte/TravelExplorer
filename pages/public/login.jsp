        ...
        <div class="container content-narrow">
            <div class="surface-block surface-block-xl">
                ...
                <form class="flow" action="#" method="post" style="margin-top: 2rem;">
                    ...
                    <%-- Duarte: este formulário deverá autenticar o utilizador e redirecionar consoante o tipo de conta (cliente ou staff/admin). --%>
                </form>
                ...
                <div class="surface-block" style="margin-top: 1.5rem;">
                    <div class="flow">
                        ...
                        <%-- Duarte: remover ou esconder este bloco quando a autenticação real estiver ligada ao backend. --%>
                    </div>
                </div>
            </div>
        </div>
