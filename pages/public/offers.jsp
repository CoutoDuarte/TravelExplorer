        ...
        <div class="container">
            ...
            <div class="public-search-box" style="margin-top: 2rem;">
                <form class="public-search-box__form" action="#" method="get">
                    ...
                    <%-- Duarte: este formulário deverá futuramente enviar os filtros para o endpoint/API de pesquisa pública de ofertas. --%>
                </form>
            </div>
        </div>
    </section>
    ...
    <section class="public-page__section public-page__section--soft">
        <div class="container">
            <div class="cards-grid">
                ...
                <%-- Duarte: esta grelha poderá mais tarde ser gerada por ciclo com dados reais vindos do backend. --%>
            </div>
        </div>
    </section>
</div>