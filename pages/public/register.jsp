        ...
        <div class="container content-narrow">
            <div class="surface-block surface-block-xl">
                ...
                <form class="flow" action="#" method="post" style="margin-top: 2rem;">
                    ...
                    <%-- Duarte: este formulário deverá criar a conta do utilizador no backend e, se necessário, iniciar sessão automaticamente após o registo. --%>
                </form>
                ...
                <div class="surface-block" style="margin-top: 1.5rem;">
                    <div class="flow">
                        ...
                        <%-- Duarte: remover ou esconder este bloco quando o registo real estiver ligado ao backend. --%>
                    </div>
                </div>
            </div>
        </div>
