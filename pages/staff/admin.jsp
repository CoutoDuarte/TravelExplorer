...
<div class="flow staff-shell">
    ...
    <%-- Duarte: esta página deverá mais tarde receber dados reais de utilizadores, permissões, definições e ações administrativas. --%>
    <%-- Duarte: estes botões estão temporariamente a apontar para a própria área de administração apenas para demonstração frontend. Quando o backend estiver ligado, cada ação deverá abrir o fluxo real correspondente. --%>
</div>