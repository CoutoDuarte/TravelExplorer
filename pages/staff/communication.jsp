...
<div class="flow staff-shell">
    ...
    <%-- Duarte: esta página deverá mais tarde receber campanhas, segmentos, estados e histórico real de comunicação da área staff. --%>
    <%-- Duarte: os botões de campanha estão temporariamente a redirecionar para a própria página apenas para demonstração frontend. Quando o backend estiver ligado, cada campanha deverá abrir o detalhe ou editor real correspondente. --%>
</div>