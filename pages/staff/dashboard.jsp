...
<div class="flow staff-shell">
    ...
    <%-- Duarte: esta dashboard deverá mais tarde receber métricas reais da área staff, como reservas, clientes, promoções e alertas operacionais. --%>
    <%-- Duarte: estes atalhos já apontam para as páginas frontend certas, mas a lógica real de criação, permissões e dados operacionais terá de ser ligada no backend. --%>
</div>