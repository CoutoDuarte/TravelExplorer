...
<div class="flow staff-shell">
    ...
    <%-- Duarte: esta página deverá mais tarde receber a lista real de promoções, estados, períodos e ações comerciais da área staff. --%>
    <%-- Duarte: os botões de promoção estão temporariamente a redirecionar para a própria página apenas para demonstração frontend. Quando o backend estiver ligado, cada promoção deverá abrir o detalhe ou editor real correspondente. --%>
</div>